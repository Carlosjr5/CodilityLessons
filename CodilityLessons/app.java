    ...
    public static void main(String[] args) {
        ...
        while (!exit) {
        	System.out.println("\n" 
                    ...
                    + "		+--------------------------------------------+"+ "\n" );
//LEFT TO DO: * _PrimeAndCompositeNumbers -> FLAGS.
//			  * _EuclideanAlgorithm -> CommonPrimeDivisors.        	 
//			  * _BinarySearchAlgorithm -> NailingPlanks.
//			  * _CaterpillarMethod -> MinAbsSumOfTwo.       	
   ...
   System.out.println("	+--------------------------------------------------------------+");
    ...
    private static void calculateChocolatesEaten() {
        ...
        SolutionChocolateByNumbers solutionChocolatesByNumbers = new SolutionChocolateByNumbers();
    ...
    private static void calculateDistinctSlices() {
        ...
        SolutionCountDistinctSlices solutionDinstinctSlices = new SolutionCountDistinctSlices();
    ...
    private static int findNumberOfIntersections(int[] discs) {
        SolutionNumberOfDiscIntersection solution = new SolutionNumberOfDiscIntersection();
    ...
    private static int solutionMinAbsSum(int[] A) {
        ...
        DynamicProgramming_MinAbsSum solutionClass = new DynamicProgramming_MinAbsSum();
